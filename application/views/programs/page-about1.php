  ...
  <div class="main-content">
    ...
    <section>
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-uppercasetext-theme-colored mt-0 mb-0 mt-sm-30">Welcome to <span class="text-theme-colored2">Imfundo</span></h2>
    ...
    <!-- Divider: Funfact -->
    <section class="layer-overlay overlay-theme-colored-9 parallax" data-bg-img="http://placehold.it/1920x1280">
    ...
    <section id="team">
      <div class="container">
        <div class="section-title mb-40">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-uppercase mb-5">Faculty <span class="text-theme-colored2">Members</span></h2>
              <h5 class="font-16 mt-5">Meet Our Skilled Teachers</h5>
            </div>
          </div>
        </div>
        <div class="section-content">
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <a href="#" class="btn btn-theme-colored2 btn-border btn-circled">Load more</a>
            </div>
          </div>
        </div>
      </div>
